...
if __name__ == "__main__":
    ...
    ax.scatter(first_coordinates_without_classification, second_coordinates_without_classification, third_coordinates_without_classification, color="green")
    ax.scatter(first_coordinates_with_classification, second_coordinates_with_classification, third_coordinates_with_classification, color="blue")
    ax.scatter(list(ACCURATE_RESULT[0]), list(ACCURATE_RESULT[1]), list(ACCURATE_RESULT[2]), color="red")
    plt.show()