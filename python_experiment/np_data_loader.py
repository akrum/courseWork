...
def fit_data_naive_classic_polynomial():
    sample_sizes = np.load(NP_DATA_PATH + "naive_classic_pol_sizes.npy")
    all_results_classic = np.load(NP_DATA_PATH + "naive_classic_pol_res_classic.npy")
    all_results_naive = np.load(NP_DATA_PATH + "naive_classic_pol_res_naive.npy")
