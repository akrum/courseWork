...
Очевидно, что каждый $y_i$ принадлежит нормальному распределению:
\begin{eqnarray}
...
\begin{eqnarray}
    ...
    =\frac{\delta \sum_{i=1}^{n} (\frac{1}{2}(\textup{erf}(\frac{a_{\mu_i+1}-f(x_i,\beta)}{\sqrt{2}\sigma^2})-\textup{erf}(\frac{a_{\mu_i}-f(x_i,\beta)}{\sqrt{2}\sigma^2})) )         }{\delta \beta}=\\
    =  \sum_{i=1}^{n} (\frac{1}{2}(\textup{erf}(\frac{a_{\mu_i+1}-f(x_i,\beta)}{\sqrt{2}\sigma^2})-\textup{erf}(\frac{a_{\mu_i}-f(x_i,\beta)}{\sqrt{2}\sigma^2}))(-1) \frac{\delta f(x_i,\beta)}{\delta \beta} )= \\
    = (-1) \sum_{i=1}^{n} (\frac{1}{2}\frac{\delta f(x_i,\beta)}{\delta \beta}\Big[ \textup{erf}(\frac{a_{\mu_i+1}-f(x_i,\beta)}{\sqrt{2}\sigma^2})-\textup{erf}(\frac{a_{\mu_i}-f(x_i,\beta)}{\sqrt{2}\sigma^2})\Big])
\end{eqnarray}
